...
def load_flags_mapping() -> Dict[str, Tuple[str, str]]:
    try:
        return {
            ...
            'Brand in Generic Name': ('1000002 - Kindly Ensure Brand Name Is Correct', "This product is listed as 'Generic', but the name starts with a known brand. Please update the Brand field."),
        }
...
def validate_products(data: pd.DataFrame, support_files: Dict, country_validator: CountryValidator, data_has_warranty_cols: bool, common_sids: Optional[set] = None, use_image_hash: bool = True, perform_quality_check: bool = True):
    ...
    validations = [
        ...
        ("Brand in Generic Name", check_generic_with_brand_in_name, {'brands_list': support_files.get('known_brands', [])}),
