...
# Tab structure
tabs = st.tabs(["PIM", "Images"])

# Tab 1: PIM
with tabs[0]:
    st.header("PIM Validation")
    ...
    if uploaded_file is not None:
        try:
            ...
            # Validation checks (current PIM logic goes here)

            # Generate report with a single reason per rejection (current PIM logic continues)
...
# Tab 2: Images
with tabs[1]:
    st.header("Images Validation")
    st.write("This tab is under development. Add your image-related functionality here!")
