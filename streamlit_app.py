...
def load_flags_mapping() -> Dict[str, Tuple[str, str]]:
    ...
    NOTE: Includes mappings for the new 'Jersey flag' and 'Restricted Brand'.
    """
    try:
...
def load_all_support_files() -> Dict:
    ...
    files = {
        ...
        'restricted_brands': load_txt_file('restricted_brands.txt'), # <--- NEW SUPPORT FILE FOR RESTRICTED BRANDS
